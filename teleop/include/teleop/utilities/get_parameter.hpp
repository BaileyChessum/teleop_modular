...
#ifndef TELEOP_GET_PARAMETER_HPP
#define TELEOP_GET_PARAMETER_HPP
...
template <typename T>
inline std::optional<T> get_parameter(const rclcpp::node_interfaces::NodeParametersInterface::SharedPtr& parameters,
                                      const std::string& name, const std::string& description);

template <typename T>
inline T get_parameter_or_default(const rclcpp::node_interfaces::NodeParametersInterface::SharedPtr& parameters,
...
template <>
inline std::optional<bool> get_parameter(const rclcpp::node_interfaces::NodeParametersInterface::SharedPtr& parameters,
                                         const std::string& name, const std::string& description)
{
...
get_parameter(const rclcpp::node_interfaces::NodeParametersInterface::SharedPtr& parameters, const std::string& name,
              const std::string& description)
{
  rcl_interfaces::msg::ParameterDescriptor from_descriptor;
  from_descriptor.name = name;
  from_descriptor.description = description;
  parameters->declare_parameter(from_descriptor.name, rclcpp::PARAMETER_BOOL_ARRAY, from_descriptor);
              ...
              const std::string& description)
{
  ...
  from_descriptor.name = name;
  from_descriptor.description = description;
  parameters->declare_parameter(from_descriptor.name, rclcpp::PARAMETER_DOUBLE_ARRAY, from_descriptor);
...
template <>
inline std::optional<float> get_parameter(const rclcpp::node_interfaces::NodeParametersInterface::SharedPtr& parameters,
                                          const std::string& name, const std::string& description)
{
  rcl_interfaces::msg::ParameterDescriptor from_descriptor;
  from_descriptor.name = name;
              ...
              const std::string& description)
{
  ...
  from_descriptor.name = name;
  from_descriptor.description = description;
  parameters->declare_parameter(from_descriptor.name, rclcpp::PARAMETER_STRING_ARRAY, from_descriptor);
              ...
              const std::string& description)
{
  ...
  from_descriptor.name = name;
  from_descriptor.description = description;
  parameters->declare_parameter(from_descriptor.name, rclcpp::PARAMETER_INTEGER_ARRAY, from_descriptor);
...
#endif  // TELEOP_GET_PARAMETER_HPP
